...
inital_DM = qutip.qobj.Qobj(numpy.array([[1,1],[0,1]])) # start in maximally mixed state
...
def DephasingKrausKreator(dephasing_value):
	...
	K_1 = qutip.qobj.Qobj(numpy.sqrt(1-dephasing_value)*(numpy.array([[1,0],[0,-1]])))
...
def DephasingPolarisationCurve(q0, phase, n_gammas):
	...
	for d in range(len(dephasing_list)):
		...
		final_dm = qutip.superoperator.vector_to_operator(dephasing_operator * pulse_operator * initial_vec)
		# print final_dm
